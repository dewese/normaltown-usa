# Publish — A Little Each Week Beats Betting It All

| Field | Value |
|---|---|
| **URL slug** | `a-little-each-week-beats-betting-it-all` |
| **Title tag** | `Dollar-Cost Averaging, Simply: A Little Each Week Beats Betting It All` |
| **Subtitle** | `Dollar-cost averaging, explained like a dripping faucet.` |
