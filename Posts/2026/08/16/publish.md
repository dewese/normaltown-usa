...
- **Image:** `hard-to-make.png` — Alt text: `On the left, a grid of many small white outlined circles labeled easy to make. On the right, one large solid cyan circle labeled hard to make, with a not-equals sign between them.`
