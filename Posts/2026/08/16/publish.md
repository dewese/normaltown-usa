# Publish — Why Hard-to-Make Money Holds Its Value
...
- **Image:** `hard-to-make.png` — Alt text: `On the left, a grid of many small plain outlined circles labeled easy to make. On the right, one large solid highlighted circle labeled hard to make, with a not-equals sign between them.`
