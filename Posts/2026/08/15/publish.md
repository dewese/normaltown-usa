# Publish — What a Deductible Really Means (No Jargon)

| Field | Value |
|---|---|
| **URL slug** | `what-a-deductible-really-means` |
| **Title tag** | `What a Deductible Means, Plus Premium, Copay, and Out-of-Pocket Max` |
| **Subtitle** | `The part of the bill that's yours before the umbrella opens.` |
