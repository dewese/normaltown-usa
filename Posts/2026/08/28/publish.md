# Publish — The Real Cost of Carrying a Credit Card Balance

| Field | Value |
|---|---|
| **URL slug** | `real-cost-of-a-credit-card-balance` |
| **Title tag** | `The Real Cost of a Credit Card Balance (and How to Pay It Off)` |
| **Subtitle** | `Your balance is a boat with a hole. The minimum payment is a small cup.` |
