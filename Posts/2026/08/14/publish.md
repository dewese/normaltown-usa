# Publish — The Dollar's Slow Leak, Explained Simple
...
- **Image:** `slow-leak.png` — Alt text: `A plain dollar-coin circle with a small highlighted puncture at the lower right and a few highlighted dots escaping, showing value leaking out slowly.`
