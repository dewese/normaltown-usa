# Publish — Stop Renting Your Subscriptions a Mansion
...
- **Image:** `lights-still-on.png` — Alt text: `A grid of room squares. Most are dark with white outlines, three are lit solid cyan, showing subscriptions still costing money in rooms nobody uses.`
