# Publish — High-Deductible Plan vs. Health Sharing: The Head-to-Head

| Field | Value |
|---|---|
| **URL slug** | `high-deductible-plan-vs-health-sharing` |
| **Title tag** | `High-Deductible Plan vs. Health Sharing: The Head-to-Head Math` |
| **Subtitle** | `If you already chose a high-deductible plan, this is the same bet made better.` |
