# Publish — What If the Crowd Doesn't Fund Your Bill?
...
- **Image:** `honest-risk.png` — Alt text: `A highlighted safety net catching a falling bill, with one small honest gap at the edge of the net.`
- **Internal links:** /p/can-you-trust-health-sharing-with-a-big-bill/
