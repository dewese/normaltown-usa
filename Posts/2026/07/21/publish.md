# Publish — The Cash Price Secret Hospitals Don't Advertise

| Field | Value |
|---|---|
| **URL slug** | `the-cash-price-secret` |
| **Title tag** | `The Cash Price Secret: How to Ask for the Cash Price at the Doctor` |
| **Subtitle** | `For a lot of everyday care, there are two prices. Here are the exact words that get you the cheaper one.` |
