# Pipeline Station 6 — CTA & Affiliate Placement

> **What this is:** The rules for *how* the brand earns money without burning trust.
> Less a generator, more a checklist the draft must pass before it ships.

## The rule above all rules
**Value first, pitch second — always.** A recommendation only appears when it's the
...
- **One** honest mention, where the content naturally leads to it (e.g., the
  "what would aligned incentives look like?" turn → CrowdHealth's flat-fee model).
- **Always disclose, plainly:** "I'm a member and may earn a small referral if you
  join through my link — no extra cost to you." (FTC-honest, friend-honest.)
- **Always tell the honest other half:** what it is NOT and who it's wrong for.
  For CrowdHealth: not insurance, no legal guarantee bills are paid, has exclusions
  and waiting periods, poor fit for someone needing guaranteed coverage for an
